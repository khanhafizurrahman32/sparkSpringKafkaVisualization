...
function getRequestOptions(jsonFetchOptions) {
  ...
  var pickedOptions = (0, _lodash2.default)(jsonFetchOptions, ['agent', 'body', 'cache', 'credentials', 'headers', 'integrity', 'method', 'mode', 'redirect', 'referrer', 'referrerPolicy', 'timeout']);
